...
const en = {
  ...
  reportV2: {
    ...
    growth: {
      ...
      subtitle: 'What is working now, and what to post next.',
      topVideos: 'Top-performing videos',
      plays: 'Views',
      likes: 'Likes',
      shares: 'Shares',
      trends: 'Trending in your niche',
      relevance: 'Relevance',
  ...
  dashboard: {
    v2: {
      ...
      home: {
        ...
        bottleneckTitle: 'Biggest bottleneck',
      ...
      profile: {
        ...
        sections: {
          ...
          danger: 'Danger zone',
          signOut: 'Sign out',
          signOutDesc: 'Ends all active sessions immediately',
        },
      },
    },
  },
