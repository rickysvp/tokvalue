              ...
              <div className="relative flex-1 flex flex-col p-10">
                ...
                >
                  <div className="flex items-center gap-2">
                    <img src={TOKVALUE_LOGO_BASE64} alt="TokValue" className="w-6 h-6 rounded-lg" />
            ...
            <button
              onClick={async () => {
                ...
                try {
                  ...
                  const shareData = {
                    title: 'My TikTok Account Value',
                    text: `My TikTok account is worth ${valueDisplay}! Check yours at tokvalue.com`,
                    files: [file],
                  }
              ...
              className="w-full inline-flex items-center justify-center gap-2 rounded-xl bg-[#141414] border border-[#262626] px-6 py-3.5 text-sm font-medium text-white hover:bg-[#1a1a1a] transition-colors"
            >
              <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor"><path d="M18 16.08c-.76 0-1.44.3-1.96.77L8.91 12.7c.05-.23.09-.46.09-.7s-.04-.47-.09-.7l7.05-4.11c.54.5 1.25.81 2.04.81 1.66 0 3-1.34 3-3s-1.34-3-3-3-3 1.34-3 3c0 .24.04.47.09.7L8.04 9.81C7.5 9.31 6.79 9 6 9c-1.66 0-3 1.34-3 3s1.34 3 3 3c.79 0 1.5-.31 2.04-.81l7.12 4.16c-.05.21-.08.43-.08.65 0 1.61 1.31 2.92 2.92 2.92s2.92-1.31 2.92-2.92-1.31-2.92-2.92-2.92z"/></svg>
              Share to Social
            </button>
          </div>
        </div>
